...
class UserTestimonialController(BaseController):
    def __init__(self):
    ...
    async def _create_testimonial(
        ...
        use_case: CreateTestimonialUseCase = Depends(get_create_testimonial_use_case),
    ):
    ...
    async def _get_testimonials(
        ...
        use_case: GetUserTestimonialsUseCase = Depends(get_user_testimonials_use_case),
    ):
...
controller = UserTestimonialController()
