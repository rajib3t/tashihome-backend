...
from app.deps.booking import (
    get_vendor_bookings_use_case,
    get_vendor_booking_detail_use_case,
    get_vendor_update_booking_status_use_case,
)
...
class BookingController(BaseController):
    ...
    async def _get_bookings(
        ...
        use_case: VendorGetBookingsUseCase = Depends(get_vendor_bookings_use_case),
    ):
    ...
    async def _get_booking(
        self,
        booking_id: str,
        use_case: VendorGetBookingDetailUseCase = Depends(get_vendor_booking_detail_use_case),
    ):
    ...
    async def _update_booking_status(
        ...
        use_case: VendorUpdateBookingStatusUseCase = Depends(get_vendor_update_booking_status_use_case),
    ):
